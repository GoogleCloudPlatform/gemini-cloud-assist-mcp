 ...
 *
 * Crucially, this tool provides a comprehensive, human-readable answer
 ...
 * or request regarding GCP resources. This should be detailed and capture the
 * exact intent of the user. The backend agent will interpret this query.
 *
