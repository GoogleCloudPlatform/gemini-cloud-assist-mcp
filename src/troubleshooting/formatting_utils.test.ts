...
const mockInvestigationData: any = JSON.parse(fs.readFileSync(realisticInvestigationPath, 'utf-8'));
...
describe('InvestigationViewer', () => {
    ...
    it('should format the observations section', () => {
        ...
        expect(obsSection).toContain('### Nodepool Scaling Issues: IP Exhaustion & Template Missing');
    });
    ...
    it('should format the investigation link', () => {
        ...
        expect(link).toContain('https://console.cloud.google.com/troubleshooting/investigations/details/8b1f9405-15b6-4830-b57e-2ff6a1dd5119');
    });
